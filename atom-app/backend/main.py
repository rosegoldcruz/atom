...
# Import routers
from routers import arbitrage, flashloan, deploy, agent, health, contact, stats, trades, tokens, zeroex
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "0x.org Integration", "description": "0x.org API for swaps and gasless transactions"},
    ]
)
...
app.include_router(zeroex.router, prefix="/0x", tags=["0x.org Integration"])
