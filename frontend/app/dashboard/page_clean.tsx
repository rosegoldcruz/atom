...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      toast.error('❌ Failed to connect to backend - Check if backend is running on port 8000');
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
        ...
        <div className="flex items-center justify-center h-64">
          ...
          <span className="ml-2 text-white">Loading REAL data from backend...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="bg-gray-900/50 border-gray-700 mb-8">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">REAL bot status and performance</CardDescription>
          </CardHeader>
          <CardContent>
